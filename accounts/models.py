...
class User(AbstractUser):
    ...
    　　django既存のユーザーモデルを継承したオリジナルユーザーモデル
        ...
        Attributes:
            ...
            c_choices: cityフィールドのchoicesオプションの選択肢
            icon: フィールド、ユーザーのアイコン画像
            prefecture: フィールド、ユーザーの活動圏（都道府県）
            city: フィールド、ユーザーの活動圏（市区町村）
    ...
    icon = models.ImageField(upload_to='media', blank=True, null=False)
    prefecture = models.IntegerField(choices=p_choices)
    city = models.IntegerField(choices=c_choices)

    def get_absolute_url(self):
        return reverse('weatherapp:home')
